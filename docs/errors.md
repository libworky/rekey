...
| `SESSION_REVOKED` | 401 | The access token was minted before the user's last password change, sign-out everywhere, session revoke or device release. | Refresh; if the refresh is gone too, sign in again. |
